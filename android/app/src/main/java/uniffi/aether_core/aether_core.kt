...
open class RustBuffer : Structure() {
    ...
    companion object {
        internal fun alloc(size: Int = 0) = uniffiRustCall() { status ->
            UniffiLib.INSTANCE.ffi_aether_core_rustbuffer_alloc(size, status)
        }.also {
            if(it.data == null) {
        ...
        internal fun free(buf: RustBuffer.ByValue) = uniffiRustCall() { status ->
            UniffiLib.INSTANCE.ffi_aether_core_rustbuffer_free(buf, status)
        }
    }
...
internal interface UniffiLib : Library {
    companion object {
        internal val INSTANCE: UniffiLib by lazy {
            loadIndirect<UniffiLib>(componentName = "aether_core")
            .also { lib: UniffiLib ->
    ...
    fun uniffi_aether_core_fn_clone_aetherengine(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Pointer
    fun uniffi_aether_core_fn_free_aetherengine(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Unit
    fun uniffi_aether_core_fn_constructor_aetherengine_new(uniffi_out_err: UniffiRustCallStatus, 
    ): Pointer
    ...
    fun uniffi_aether_core_fn_method_aetherengine_seed_manifest_sequence(`ptr`: Pointer,`modelId`: RustBuffer.ByValue,`sequence`: Long,uniffi_out_err: UniffiRustCallStatus, 
    ): Unit
    ...
    fun uniffi_aether_core_fn_method_aetherengine_verify_manifest_with_sequence(`ptr`: Pointer,`modelId`: RustBuffer.ByValue,`sequence`: Long,`canonicalJson`: RustBuffer.ByValue,`sigHex`: RustBuffer.ByValue,`publicKeyDer`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
    ): Unit
    fun ffi_aether_core_rustbuffer_alloc(`size`: Int,uniffi_out_err: UniffiRustCallStatus, 
    ): RustBuffer.ByValue
    fun ffi_aether_core_rustbuffer_from_bytes(`bytes`: ForeignBytes.ByValue,uniffi_out_err: UniffiRustCallStatus, 
    ): RustBuffer.ByValue
    fun ffi_aether_core_rustbuffer_free(`buf`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
    ): Unit
    fun ffi_aether_core_rustbuffer_reserve(`buf`: RustBuffer.ByValue,`additional`: Int,uniffi_out_err: UniffiRustCallStatus, 
    ): RustBuffer.ByValue
    fun ffi_aether_core_rust_future_poll_u8(`handle`: Pointer,`callback`: UniFffiRustFutureContinuationCallbackType,`callbackData`: USize,
    ): Unit
    fun ffi_aether_core_rust_future_cancel_u8(`handle`: Pointer,
    ): Unit
    fun ffi_aether_core_rust_future_free_u8(`handle`: Pointer,
    ): Unit
    fun ffi_aether_core_rust_future_complete_u8(`handle`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Byte
    fun ffi_aether_core_rust_future_poll_i8(`handle`: Pointer,`callback`: UniFffiRustFutureContinuationCallbackType,`callbackData`: USize,
    ): Unit
    fun ffi_aether_core_rust_future_cancel_i8(`handle`: Pointer,
    ): Unit
    fun ffi_aether_core_rust_future_free_i8(`handle`: Pointer,
    ): Unit
    fun ffi_aether_core_rust_future_complete_i8(`handle`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Byte
    fun ffi_aether_core_rust_future_poll_u16(`handle`: Pointer,`callback`: UniFffiRustFutureContinuationCallbackType,`callbackData`: USize,
    ): Unit
    fun ffi_aether_core_rust_future_cancel_u16(`handle`: Pointer,
    ): Unit
    fun ffi_aether_core_rust_future_free_u16(`handle`: Pointer,
    ): Unit
    fun ffi_aether_core_rust_future_complete_u16(`handle`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Short
    fun ffi_aether_core_rust_future_poll_i16(`handle`: Pointer,`callback`: UniFffiRustFutureContinuationCallbackType,`callbackData`: USize,
    ): Unit
    fun ffi_aether_core_rust_future_cancel_i16(`handle`: Pointer,
    ): Unit
    fun ffi_aether_core_rust_future_free_i16(`handle`: Pointer,
    ): Unit
    fun ffi_aether_core_rust_future_complete_i16(`handle`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Short
    fun ffi_aether_core_rust_future_poll_u32(`handle`: Pointer,`callback`: UniFffiRustFutureContinuationCallbackType,`callbackData`: USize,
    ): Unit
    fun ffi_aether_core_rust_future_cancel_u32(`handle`: Pointer,
    ): Unit
    fun ffi_aether_core_rust_future_free_u32(`handle`: Pointer,
    ): Unit
    fun ffi_aether_core_rust_future_complete_u32(`handle`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Int
    fun ffi_aether_core_rust_future_poll_i32(`handle`: Pointer,`callback`: UniFffiRustFutureContinuationCallbackType,`callbackData`: USize,
    ): Unit
    fun ffi_aether_core_rust_future_cancel_i32(`handle`: Pointer,
    ): Unit
    fun ffi_aether_core_rust_future_free_i32(`handle`: Pointer,
    ): Unit
    fun ffi_aether_core_rust_future_complete_i32(`handle`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Int
    fun ffi_aether_core_rust_future_poll_u64(`handle`: Pointer,`callback`: UniFffiRustFutureContinuationCallbackType,`callbackData`: USize,
    ): Unit
    fun ffi_aether_core_rust_future_cancel_u64(`handle`: Pointer,
    ): Unit
    fun ffi_aether_core_rust_future_free_u64(`handle`: Pointer,
    ): Unit
    fun ffi_aether_core_rust_future_complete_u64(`handle`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Long
    fun ffi_aether_core_rust_future_poll_i64(`handle`: Pointer,`callback`: UniFffiRustFutureContinuationCallbackType,`callbackData`: USize,
    ): Unit
    fun ffi_aether_core_rust_future_cancel_i64(`handle`: Pointer,
    ): Unit
    fun ffi_aether_core_rust_future_free_i64(`handle`: Pointer,
    ): Unit
    fun ffi_aether_core_rust_future_complete_i64(`handle`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Long
    fun ffi_aether_core_rust_future_poll_f32(`handle`: Pointer,`callback`: UniFffiRustFutureContinuationCallbackType,`callbackData`: USize,
    ): Unit
    fun ffi_aether_core_rust_future_cancel_f32(`handle`: Pointer,
    ): Unit
    fun ffi_aether_core_rust_future_free_f32(`handle`: Pointer,
    ): Unit
    fun ffi_aether_core_rust_future_complete_f32(`handle`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Float
    fun ffi_aether_core_rust_future_poll_f64(`handle`: Pointer,`callback`: UniFffiRustFutureContinuationCallbackType,`callbackData`: USize,
    ): Unit
    fun ffi_aether_core_rust_future_cancel_f64(`handle`: Pointer,
    ): Unit
    fun ffi_aether_core_rust_future_free_f64(`handle`: Pointer,
    ): Unit
    fun ffi_aether_core_rust_future_complete_f64(`handle`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Double
    fun ffi_aether_core_rust_future_poll_pointer(`handle`: Pointer,`callback`: UniFffiRustFutureContinuationCallbackType,`callbackData`: USize,
    ): Unit
    fun ffi_aether_core_rust_future_cancel_pointer(`handle`: Pointer,
    ): Unit
    fun ffi_aether_core_rust_future_free_pointer(`handle`: Pointer,
    ): Unit
    fun ffi_aether_core_rust_future_complete_pointer(`handle`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Pointer
    fun ffi_aether_core_rust_future_poll_rust_buffer(`handle`: Pointer,`callback`: UniFffiRustFutureContinuationCallbackType,`callbackData`: USize,
    ): Unit
    fun ffi_aether_core_rust_future_cancel_rust_buffer(`handle`: Pointer,
    ): Unit
    fun ffi_aether_core_rust_future_free_rust_buffer(`handle`: Pointer,
    ): Unit
    fun ffi_aether_core_rust_future_complete_rust_buffer(`handle`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): RustBuffer.ByValue
    fun ffi_aether_core_rust_future_poll_void(`handle`: Pointer,`callback`: UniFffiRustFutureContinuationCallbackType,`callbackData`: USize,
    ): Unit
    fun ffi_aether_core_rust_future_cancel_void(`handle`: Pointer,
    ): Unit
    fun ffi_aether_core_rust_future_free_void(`handle`: Pointer,
    ): Unit
    fun ffi_aether_core_rust_future_complete_void(`handle`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Unit
    ...
    fun uniffi_aether_core_checksum_method_aetherengine_seed_manifest_sequence(
    ): Short
    ...
    fun uniffi_aether_core_checksum_method_aetherengine_verify_manifest_with_sequence(
    ): Short
    fun uniffi_aether_core_checksum_constructor_aetherengine_new(
    ): Short
    fun ffi_aether_core_uniffi_contract_version(
    ): Int
...
private fun uniffiCheckContractApiVersion(lib: UniffiLib) {
    ...
    val scaffolding_contract_version = lib.ffi_aether_core_uniffi_contract_version()
...
private fun uniffiCheckApiChecksums(lib: UniffiLib) {
    ...
    if (lib.uniffi_aether_core_checksum_method_aetherengine_seed_manifest_sequence() != 7250.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    ...
    if (lib.uniffi_aether_core_checksum_method_aetherengine_start_server() != 21781.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
...
public interface AetherEngineInterface {
    ...
    fun `verifyManifestWithSequence`(`modelId`: String, `sequence`: ULong, `canonicalJson`: String, `sigHex`: String, `publicKeyDer`: ByteArray)
    
    companion object
}

open class AetherEngine : FFIObject, AetherEngineInterface {
        ...
        override fun run() {
            pointer?.let { ptr ->
                uniffiRustCall { status ->
                    UniffiLib.INSTANCE.uniffi_aether_core_fn_free_aetherengine(ptr, status)
                }
            }
        }
    }
    ...
    override fun uniffiClonePointer(): Pointer {
        return uniffiRustCall() { status ->
            UniffiLib.INSTANCE.uniffi_aether_core_fn_clone_aetherengine(pointer!!, status)
        }
    }

    
    @Throws(AetherException::class)override fun `applyPatch`(`oldFd`: Int, `patchFd`: Int, `newFd`: Int, `expectedPatchSha256`: String, `expectedOutputSha256`: String) =
        callWithPointer {
    uniffiRustCallWithError(AetherException) { _status ->
    UniffiLib.INSTANCE.uniffi_aether_core_fn_method_aetherengine_apply_patch(it,
    ...
    @Throws(AetherException::class)override fun `checkPatchRamFeasibility`(`oldFileSize`: ULong, `patchFileSize`: ULong) =
        callWithPointer {
    uniffiRustCallWithError(AetherException) { _status ->
    UniffiLib.INSTANCE.uniffi_aether_core_fn_method_aetherengine_check_patch_ram_feasibility(it,
        FfiConverterULong.lower(`oldFileSize`),FfiConverterULong.lower(`patchFileSize`),
        _status)
}
        }
    ...
    @Throws(AetherException::class)override fun `decompressFile`(`compressedFd`: Int, `outputFd`: Int): ULong =
        callWithPointer {
    uniffiRustCallWithError(AetherException) { _status ->
    UniffiLib.INSTANCE.uniffi_aether_core_fn_method_aetherengine_decompress_file(it,
        FfiConverterInt.lower(`compressedFd`),FfiConverterInt.lower(`outputFd`),
        _status)
}
        }.let {
    ...
    @Throws(AetherException::class)override fun `grantPeerModelAccess`(`peerId`: String, `modelId`: String) =
        callWithPointer {
    uniffiRustCallWithError(AetherException) { _status ->
    UniffiLib.INSTANCE.uniffi_aether_core_fn_method_aetherengine_grant_peer_model_access(it,
        FfiConverterString.lower(`peerId`),FfiConverterString.lower(`modelId`),
        _status)
}
        }
    ...
    @Throws(AetherException::class)override fun `heartbeat`() =
        callWithPointer {
    uniffiRustCallWithError(AetherException) { _status ->
    UniffiLib.INSTANCE.uniffi_aether_core_fn_method_aetherengine_heartbeat(it,
    ...
    @Throws(AetherException::class)override fun `pingPeer`(`peerIp`: String, `peerPort`: UShort): Boolean =
        callWithPointer {
    uniffiRustCallWithError(AetherException) { _status ->
    UniffiLib.INSTANCE.uniffi_aether_core_fn_method_aetherengine_ping_peer(it,
        FfiConverterString.lower(`peerIp`),FfiConverterUShort.lower(`peerPort`),
        _status)
}
        }.let {
            FfiConverterBoolean.lift(it)
    ...
    @Throws(AetherException::class)override fun `registerFileForServing`(`modelId`: String, `filePath`: String) =
        callWithPointer {
    uniffiRustCallWithError(AetherException) { _status ->
    UniffiLib.INSTANCE.uniffi_aether_core_fn_method_aetherengine_register_file_for_serving(it,
        FfiConverterString.lower(`modelId`),FfiConverterString.lower(`filePath`),
        _status)
}
        }
    ...
    @Throws(AetherException::class)override fun `registerPeerKey`(`peerId`: String, `sharedSecret`: ByteArray) =
        callWithPointer {
    uniffiRustCallWithError(AetherException) { _status ->
    ...
    @Throws(AetherException::class)override fun `seedManifestSequence`(`modelId`: String, `sequence`: ULong) =
        callWithPointer {
    uniffiRustCallWithError(AetherException) { _status ->
    UniffiLib.INSTANCE.uniffi_aether_core_fn_method_aetherengine_seed_manifest_sequence(it,
        FfiConverterString.lower(`modelId`),FfiConverterULong.lower(`sequence`),
        _status)
}
        }
    ...
    @Throws(AetherException::class)override fun `startServer`(): UShort =
        callWithPointer {
    uniffiRustCallWithError(AetherException) { _status ->
    UniffiLib.INSTANCE.uniffi_aether_core_fn_method_aetherengine_start_server(it,
    ...
    @Throws(AetherException::class)override fun `verifyManifest`(`canonicalJson`: String, `sigHex`: String, `publicKeyDer`: ByteArray): Boolean =
        callWithPointer {
    uniffiRustCallWithError(AetherException) { _status ->
    UniffiLib.INSTANCE.uniffi_aether_core_fn_method_aetherengine_verify_manifest(it,
        FfiConverterString.lower(`canonicalJson`),FfiConverterString.lower(`sigHex`),FfiConverterByteArray.lower(`publicKeyDer`),
        _status)
}
        }.let {
            FfiConverterBoolean.lift(it)
    ...
    @Throws(AetherException::class)override fun `verifyManifestWithSequence`(`modelId`: String, `sequence`: ULong, `canonicalJson`: String, `sigHex`: String, `publicKeyDer`: ByteArray) =
        callWithPointer {
    uniffiRustCallWithError(AetherException) { _status ->
    UniffiLib.INSTANCE.uniffi_aether_core_fn_method_aetherengine_verify_manifest_with_sequence(it,
        FfiConverterString.lower(`modelId`),FfiConverterULong.lower(`sequence`),FfiConverterString.lower(`canonicalJson`),FfiConverterString.lower(`sigHex`),FfiConverterByteArray.lower(`publicKeyDer`),
        _status)
}
        }
...
public object FfiConverterTypeAetherEngine: FfiConverter<AetherEngine, Pointer> {

    override fun lower(value: AetherEngine): Pointer {
        return value.uniffiClonePointer()
    }

    override fun lift(value: Pointer): AetherEngine {
        return AetherEngine(value)
    }

    override fun read(buf: ByteBuffer): AetherEngine {
        // The Rust code always writes pointers as 8 bytes, and will
        // fail to compile if they don't fit.
        return lift(Pointer(buf.getLong()))
    }

    override fun allocationSize(value: AetherEngine) = 8

    override fun write(value: AetherEngine, buf: ByteBuffer) {
...
sealed class AetherException(message: String): Exception(message) {
        
        class ServerStartupException(message: String) : AetherException(message)
        
        class NetworkException(message: String) : AetherException(message)
        
        class SecurityException(message: String) : AetherException(message)
        
        class InvalidTicket(message: String) : AetherException(message)
        
        class KeyExchangeFailed(message: String) : AetherException(message)
        
        class PeerNotFound(message: String) : AetherException(message)
        
        class PatchException(message: String) : AetherException(message)
        
        class ChecksumMismatch(message: String) : AetherException(message)
        
        class DecompressException(message: String) : AetherException(message)
        
        class SignatureVerificationFailed(message: String) : AetherException(message)
        
        class DownloadIncomplete(message: String) : AetherException(message)
        
        class RateLimitExceeded(message: String) : AetherException(message)
        
        class InternalException(message: String) : AetherException(message)
...
public object FfiConverterTypeAetherError : FfiConverterRustBuffer<AetherException> {
    override fun read(buf: ByteBuffer): AetherException {
            ...
            1 -> AetherException.ServerStartupException(FfiConverterString.read(buf))
            2 -> AetherException.NetworkException(FfiConverterString.read(buf))
            3 -> AetherException.SecurityException(FfiConverterString.read(buf))
            4 -> AetherException.InvalidTicket(FfiConverterString.read(buf))
            5 -> AetherException.KeyExchangeFailed(FfiConverterString.read(buf))
            6 -> AetherException.PeerNotFound(FfiConverterString.read(buf))
            7 -> AetherException.PatchException(FfiConverterString.read(buf))
            8 -> AetherException.ChecksumMismatch(FfiConverterString.read(buf))
            9 -> AetherException.DecompressException(FfiConverterString.read(buf))
            10 -> AetherException.SignatureVerificationFailed(FfiConverterString.read(buf))
            11 -> AetherException.DownloadIncomplete(FfiConverterString.read(buf))
            12 -> AetherException.RateLimitExceeded(FfiConverterString.read(buf))
            13 -> AetherException.InternalException(FfiConverterString.read(buf))
            else -> throw RuntimeException("invalid error enum value, something is very wrong!!")
        }
        
    }

    override fun allocationSize(value: AetherException): Int {
        return 4
    }

    override fun write(value: AetherException, buf: ByteBuffer) {
        when(value) {
            is AetherException.ServerStartupException -> {
                buf.putInt(1)
                Unit
            }
            is AetherException.NetworkException -> {
                buf.putInt(2)
                Unit
            }
            is AetherException.SecurityException -> {
                buf.putInt(3)
                Unit
            }
            is AetherException.InvalidTicket -> {
                buf.putInt(4)
                Unit
            }
            is AetherException.KeyExchangeFailed -> {
                buf.putInt(5)
                Unit
            }
            is AetherException.PeerNotFound -> {
                buf.putInt(6)
                Unit
            }
            is AetherException.PatchException -> {
                buf.putInt(7)
                Unit
            }
            is AetherException.ChecksumMismatch -> {
                buf.putInt(8)
                Unit
            }
            is AetherException.DecompressException -> {
                buf.putInt(9)
                Unit
            }
            is AetherException.SignatureVerificationFailed -> {
                buf.putInt(10)
                Unit
            }
            is AetherException.DownloadIncomplete -> {
                buf.putInt(11)
                Unit
            }
            is AetherException.RateLimitExceeded -> {
                buf.putInt(12)
                Unit
            }
            is AetherException.InternalException -> {
                buf.putInt(13)
                Unit
            }
